...
class fake_exchange:
    ...
    def buy(self, qty, value):
        ...
        logger.info(f'''
        Exchange recieved and fulfilled a request to buy
         {qty} {self.SECURITY} for {amount_to_deduct}
         ''')
    ...
    def sell(self, qty, value):
        ...
        self.num_sales += 1
        logger.info(f'''
        Exchange recieved and fulfilled a request to sell
         {qty} {self.SECURITY} for {amount_to_award}
         ''')
    ...
    def trading_summary(self):
        ...
        return f'''
I made {self.num_purchases} purchases and {self.num_sales} sales and came away
with a profit of {self.profit_loss} {emoji}
